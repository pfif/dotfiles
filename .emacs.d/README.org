...
(use-package general
  ...
  (leader-def
    ...
    "z" (lambda () (interactive) (when (fboundp 'deft-setup) (deft-setup)) (deft))
    )
  (general-define-key
   "s-m" 'suspend-frame
...
(setq
 org-agenda-files (seq-filter
                   ...
                   '("~/local_tasklist/local_tasklist.org"
                     ...
                     "~/Dropbox/ost-tasklist/zettlekasten/"
                     ))
...
(setq org-agenda-custom-commands '(("w" "Florent's Work View"
                                   ...
                                   ("c" "Cleaning"
                                    ((agenda "" ((org-agenda-span 1)))
                                     (tags-todo "cleaningforothers")
                                     (tags-todo "cleaningformyself"))
...
:END:
#+begin_src emacs-lisp :tangle yes
(defun pfif/zettlekasten-file-name ()
  (interactive)
  (let ((today (mapcar 'number-to-string (calendar-current-date))))
    (find-file (concat "~/Dropbox/ost-tasklist/zettlekasten/" (nth 2 today) (nth 0 today) (nth 1 today) "-" (read-from-minibuffer "Entry title (filename): ") ".org"))))
...
(setq org-capture-templates
      '(
        ...
        ("z" "Zettlekasten")
        ("zz" "New entry" entry
         (function pfif/zettlekasten-file-name)
         "* %^{Entry title} %^G\n%t\n%?\n\nSources:\n-\n\nLinks:\n-")
        ("zc" "New entry (from region)" entry
         (function pfif/zettlekasten-file-name)
         "* %^{Entry title} %^G\n%t\n%i\n\nSources:\n-\n\nLinks:\n-")
        ("c" "Cleaning")
...
#+end_src
*** Automatically commit on save
:PROPERTIES:
:ID:       E561B086-3FFF-4DC5-B269-D2E76B55A5B5
:END:
#+begin_src emacs-lisp :tangle yes
(use-package git-auto-commit-mode
  :hook (org-mode . (lambda ()
                      (when (and buffer-file-name (string-match "/tasklist/" buffer-file-name))
...
** Deft
:PROPERTIES:
:ID:       720E0C87-DB16-4509-9D72-1422C78CBA27
:END:
#+begin_src emacs-lisp :tangle yes
(use-package deft
  :commands (deft)
  :config (setq deft-directory "~/tasklist/zettlekasten/"
                deft-extensions '("org"))
  )
#+end_src
** Terraform
