...
values."
  ...
  (setq-default
   ...
   ;; Swoop uses fuzzy search, epicness ensue
...
`dotspacemacs/user-config' first."
  ...
  ;; Remap promote and demote in org-mode
  )
